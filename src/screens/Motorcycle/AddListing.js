...
export default function AddListing() {
    ...
    const createListing = () => {
        try{
            fetch(BASE_URL+'listings/motorcycles/store',{
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
                                ...
                                <View flexDirection='row' style={custom_style.form_container}>
                                    <View style={{flex: 1, paddingRight: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            style={custom_style.input}
                                            value={primaryColor}
                                            onChangeText={(e) => setPrimaryColor(e)}
                                        />
                                    </View>
                                    <View style={{flex: 1, paddingLeft: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(e) => setSecondaryColor(e)}
                                        />
                                    </View>
                                </View>
                                <View flexDirection='row' style={custom_style.form_container}>
                                    <View style={{flex: 1, paddingRight: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(e) => setFrontSuspension(e)}
                                        />
                                    </View>
                                    <View style={{flex: 1, paddingLeft: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(e) => setRearSuspension(e)}
                                        />
                                    </View>
                                </View>
                                <View flexDirection='row' style={custom_style.form_container}>
                                    <View style={{flex: 1, paddingRight: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            style={custom_style.input}
                                            value={frontBrake}
                                            onChangeText={(e) => setFrontBrake(e)}
                                        />
                                    </View>
                                    <View style={{flex: 1, paddingLeft: 5}}>
                                ...
                                <View flexDirection='row' style={custom_style.form_container}>
                                    ...
                                    <View style={{flex: 1, paddingLeft: 5}}>
                                        ...
                                        <TextInput
                                            ...
                                            onChangeText={(e) => setBatteryVoltage(e)}
                                        />
                                    </View>
                                </View>
                                <View flexDirection='row' style={custom_style.form_container}>
